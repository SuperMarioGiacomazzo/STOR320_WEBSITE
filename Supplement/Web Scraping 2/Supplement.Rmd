...
US_CENSUS2 = US_CENSUS %>%
                ...
                mutate(`2021 Pop.`=as.numeric(str_replace_all(`2021 Pop.`,"[,]",""))) %>%
                mutate(`2010 Census`=as.numeric(str_replace_all(`2010 Census`,"[,]",""))) %>%
                mutate(Change=(`2021 Pop.`-`2010 Census`)/`2010 Census`*100)
