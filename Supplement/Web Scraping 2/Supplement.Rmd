...
In this dataset, we have the population of cities in 2020 and 2022. We also have the area of each of the cities. Using this information we would like to create a variable `Change` which represents percentage change in population from 2020 to 2022, and we would like to create a variable called `Density` which is the population density in 2022. In order to do that, we need to start by getting our population variables to be numeric.
