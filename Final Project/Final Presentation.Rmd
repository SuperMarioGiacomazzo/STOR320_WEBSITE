...
The quality of slides will also be subjectively scored on a scale from 0 to 3. Slides should not be cluttered, too wordy, unreadable, or plain. A minimum of 4 visuals is required. These are visuals made from the data. These visuals can come directly from your paper. Each visual should have a purpose in the presentation and should be at the highest level. 
