---
title: "Mini Project 6: Statistical Programming with Daily Delhi Climate Data"
...
Also, we create a new variable called `Temperature 5-Day Average` in TRAIN.FINAL that starts with all missing values. Each value of `Temperature 5-Day Average` can be calculated using a formula using a formula similar to the one above. You will need to see the pattern.
